...
Need to [install docker](https://docs.docker.com/docker-for-mac/install/).
...
**$(pwd)** is just a way to indicate the path to the conf file inside the command. Supposing your are in the directory containing your nginx.conf file, of course.
